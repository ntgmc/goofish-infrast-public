export const personalUseCopy = {
  ...
  declaration_version: '版本 V1.0 / 生效日期：2026-07-23',
  ...
  terms_personal_use_intro: '免费预览权益及其生成成果适用下列《个人使用声明》（V1.0 / 生效日期：2026-07-23）；该声明仅自该日起适用于之后发生的使用行为，不以新条款单独追溯此前行为。',
  sections: [
    {
      id: 'personal-use-scope',
      heading: '1. 使用范围',
      paragraphs: [
        '本服务（含本次高级权益体验）仅限用户本人为其绑定游戏账号进行非商业性排班规划与参考使用。所有生成内容（包括但不限于排班方案、分析报告、MAA JSON 文件、预设配置等）不得用于商业目的。',
      ],
      items: [],
    },
    {
