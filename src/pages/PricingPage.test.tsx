...
describe('PricingPage', () => {
  it('renders the duration-based single-account plans and full disclosure policy', () => {
    ...
    expect(screen.getByRole('heading', { name: '单账号 CDK' })).toBeInTheDocument()
    ...
    expect(within(table).getAllByText('月卡').length).toBeGreaterThan(0)
    expect(within(table).getByText('31 天')).toBeInTheDocument()
