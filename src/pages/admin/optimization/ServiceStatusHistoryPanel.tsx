...
import type { AdminServiceStatusResponse, StatusIncidentImpact, StatusIncidentState } from '../../../lib/service-status'
...
export default function ServiceStatusHistoryPanel() {
  ...
  const load = useCallback(async () => {
    ...
    try {
      ...
      setData(value?.history ? value : EMPTY); setError(null)
