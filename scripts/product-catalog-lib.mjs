...
| 版本 | 价格 | 核心内容 | 适合用户 |
| --- | ---: | --- | --- |
| ${tableCell(free.label)} | 0 元 | ${tableCell(free.summary)} | ${tableCell(free.audience)} |
| ${tableCell(lifetime.label)} | ${lifetime.price.amount} 元 | ${tableCell(lifetime.summary)} | ${tableCell(lifetime.audience)} |
...
| 功能 | 免费预览 | 单账号终身版 CDK |
| --- | --- | --- |
${value.policies.public_feature_comparison.map((row) => `| ${tableCell(row.feature)} | ${tableCell(row.free_preview)} | ${tableCell(row.single_account_lifetime)} |`).join('\n')}
